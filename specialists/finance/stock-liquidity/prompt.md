# stock-liquidity Internal Specialist

## Purpose
Apply the curated stock-liquidity method inside Search Agent workflow nodes: finance_specialist.
...
Curated from `vendor/finance/plugins/market-analysis/skills/stock-liquidity/SKILL.md` under the pinned vendor snapshot recorded in `specialists/vendor.lock.json`; consult vendor content as reference, not as a discoverable internal Skill.
