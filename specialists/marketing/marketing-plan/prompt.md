# marketing-plan Internal Specialist

## Purpose
Apply the curated marketing-plan method inside Search Agent workflow nodes: intent_router, marketing_specialist.
...
Curated from `vendor/marketing/skills/marketing-plan/SKILL.md` under the pinned vendor snapshot recorded in `specialists/vendor.lock.json`; consult vendor content as reference, not as a discoverable internal Skill.
