# funda-data Internal Specialist

## Purpose
Apply the curated funda-data method inside Search Agent workflow nodes: finance_data_hunter, finance_specialist.
...
Curated from `vendor/finance/plugins/data-providers/skills/funda-data/SKILL.md` under the pinned vendor snapshot recorded in `specialists/vendor.lock.json`; consult vendor content as reference, not as a discoverable internal Skill.
