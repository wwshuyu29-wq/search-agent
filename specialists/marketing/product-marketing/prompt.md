# product-marketing Internal Specialist

## Purpose
Apply the curated product-marketing method inside Search Agent workflow nodes: intent_router, marketing_specialist.
...
Curated from `vendor/marketing/skills/product-marketing/SKILL.md` under the pinned vendor snapshot recorded in `specialists/vendor.lock.json`; consult vendor content as reference, not as a discoverable internal Skill.
