# startup-analysis Internal Specialist

## Purpose
Apply the curated startup-analysis method inside Search Agent workflow nodes: intent_router, finance_specialist.
...
Curated from `vendor/finance/plugins/startup-tools/skills/startup-analysis/SKILL.md` under the pinned vendor snapshot recorded in `specialists/vendor.lock.json`; consult vendor content as reference, not as a discoverable internal Skill.
