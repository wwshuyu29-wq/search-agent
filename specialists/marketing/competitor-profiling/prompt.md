# competitor-profiling Internal Specialist

## Purpose
Apply the curated competitor-profiling method inside Search Agent workflow nodes: search_planner, marketing_specialist.
...
Curated from `vendor/marketing/skills/competitor-profiling/SKILL.md` under the pinned vendor snapshot recorded in `specialists/vendor.lock.json`; consult vendor content as reference, not as a discoverable internal Skill.
