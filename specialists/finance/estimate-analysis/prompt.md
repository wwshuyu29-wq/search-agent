# estimate-analysis Internal Specialist

## Purpose
Apply the curated estimate-analysis method inside Search Agent workflow nodes: finance_specialist.
...
Curated from `vendor/finance/plugins/market-analysis/skills/estimate-analysis/SKILL.md` under the pinned vendor snapshot recorded in `specialists/vendor.lock.json`; consult vendor content as reference, not as a discoverable internal Skill.
