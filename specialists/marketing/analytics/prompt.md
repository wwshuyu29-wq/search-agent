# analytics Internal Specialist

## Purpose
Apply the curated analytics method inside Search Agent workflow nodes: marketing_specialist.
...
Curated from `vendor/marketing/skills/analytics/SKILL.md` under the pinned vendor snapshot recorded in `specialists/vendor.lock.json`; consult vendor content as reference, not as a discoverable internal Skill.
